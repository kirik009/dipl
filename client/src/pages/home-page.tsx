          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Тренируйся в составлении английских предложений, изучай
                грамматические правила и следи за своим прогрессом
              </p>
        ...
        <div id="features" className="py-16 bg-gray-50">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Платформа предоставит все, что нужно для эффективной тренировки
              построения предложений.
            </p>
          </div>

          <div
            className={isMobile ? "flex flex-col" : "grid grid-cols-3 gap-8"}
          >
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600">
                Составляй слова интуитивно, используя drag-and-drop систему для
                формирования правильных предложений.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600">
                Следи за своим совершенствованием, используя детальную
                статистику.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600">
                Развивайся от начального до продвинутого уровня с упражнениями,
                подобранными под ваш уровень.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm col-span-1 col-start-1">
              ...
              <p className="text-gray-600">
                Мгновенные исправления и пояснения, помогающие понять допущенную
                ошибку.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm col-span-1 col-start-3">
              ...
              <p className="text-gray-600">
                Изучай правила, необходимые для формирования каждого
                предложения.
              </p>
            </div>
          </div>
