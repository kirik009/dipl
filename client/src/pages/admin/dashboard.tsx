...
export default function AdminDashboard() {
  ...
  const isEditingExercise =
    location.includes("/exercises/new") ||
    (location.includes("/exercises/") && location.includes("/edit"));
  const isEditingTask =
    location.includes("/tasks/new") ||
    (location.includes("/tasks/") && location.includes("/edit"));
                ...
                <div className="flex justify-between items-center">
                  {user.role == "admin" ? (
                    <>
                      ...
                      <div className="bg-red-500 px-3 py-1 rounded-full text-sm font-medium">
                        Администратор
                      </div>
                    </>
                  ) : (
